            ...
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-2">
              <div>
                ...
                <div class="order-code">
                  Mã đơn: <span id="litOrderCode" runat="server"></span>
                </div>
              </div>
              <div class="text-end">
                <span id="litStatus" runat="server" class="order-status-pill">
                  <!-- text trạng thái sẽ được set từ code-behind -->
                </span>
              </div>
            </div>
        ...
        <div class="col-lg-4">
          <asp:Panel ID="pnlSummary" runat="server" Visible="false" CssClass="card-order">
            ...
            <div class="summary-line total">
              ...
              <div class="value">
                <asp:Literal ID="litPayTotal" runat="server" />
              </div>
            </div>
          </asp:Panel>
        </div>
