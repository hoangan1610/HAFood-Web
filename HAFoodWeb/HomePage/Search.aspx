...
<head runat="server">
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .sort-select option{ text-align:center; }
    ...
    .sidebar-col{}
    .cat-card{
      border-radius:1rem; box-shadow:var(--soft-shadow); border:0; background:#ffffff;
    }
    .cat-card .card-header{
      background:#fff7ec; border-bottom:1px solid #ffe1c2;
      border-radius:1rem 1rem 0 0 !important; padding:.7rem .95rem;
    }
    .cat-card .card-header h5{
      margin:0; font-size:1rem; font-weight:600; color:#e66000;
    }
    .cat-card .card-body{ padding:.85rem .95rem 1rem; font-size:.9rem; }

    .filter-section-title{
      font-size:.9rem; font-weight:600; color:#343a40;
      margin-bottom:.5rem; margin-top:.75rem;
    }
