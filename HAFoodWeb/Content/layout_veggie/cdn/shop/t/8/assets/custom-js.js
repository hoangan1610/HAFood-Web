$(document).ready(function() {
  ...
  jQuery(".product-single__thumbs img.featured-image").addClass("open");
  ...
  $('body:not(.rtl) #ttcmsservices2 .block_content').owlCarousel({
    items: 3,
    nav: false,
    dots: false,
    loop: false,
  ...
  $('body.rtl #ttcmsservices2 .block_content').owlCarousel({
    items: 3,
    nav: false,
    dots:false,
    loop: false,
...
function responsiveMenu(){
  if(jQuery(window).width() < 992) {
    ...
    jQuery(".header_3 .fixed-header .menu_wrapper.sticky_header.fixed .menu_toggle_wrap .header-Top").insertBefore( ".header_3 .fixed-header .menu_wrapper.sticky_header.fixed #shopify-section-TT-megamenu" );
    ...
    jQuery("#shopify-section-footer-model-3 .footer-bottom-wrap .footer-bottom .footer-cms.block_newsletter").insertAfter( "#shopify-section-footer-model-3 .footer-wrap .footer-column.contactus" );
  }
}
