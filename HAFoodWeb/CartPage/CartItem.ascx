<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CartItem.ascx.cs" Inherits="HAFoodWeb.Cart.CartItem"%>
    ...
    <style>
    /* Đồng bộ với grid header */
    .cart-item {
        display: grid;
        grid-template-columns: 40px 120px 1fr 90px 120px 120px 60px;
        gap: 12px;
        align-items: center;
        padding: 18px 6px;
    ...
    .btn-qty {
        ...
        border:1px solid #ddd; border-radius:4px; cursor:pointer; background:#fff;
    }
...
<div class="cart-item">
    ...
    <div class="cart-item-qty">
        <!-- *Không* khai báo OnCommand ở đây để event bubble lên Repeater -->
